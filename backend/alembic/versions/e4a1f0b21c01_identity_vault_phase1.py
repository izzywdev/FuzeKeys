...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "identity_id", sa.Integer(), sa.ForeignKey("identities.id"), nullable=False
        ),
    ...
    op.add_column(
        "identities",
        sa.Column("vault_collection_ref", sa.String(length=255), nullable=True),
    )
    op.add_column(
        "accounts", sa.Column("vault_item_ref", sa.String(length=255), nullable=True)
    )
