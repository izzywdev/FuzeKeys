...
from app.integrations.google.backend.models import (
    GoogleSignupConfig,
    GoogleSignupData,
    GoogleSignupResult,
)
...
async def _get_owned_identity(
    identity_id: int, current_user: User, db: AsyncSession
) -> Identity:
    ...
    try:
        ...
        return {
            ...
            "signup_data": {
                ...
                "birth_date": str(signup_data.birth_date)
                if signup_data.birth_date
                else None,
