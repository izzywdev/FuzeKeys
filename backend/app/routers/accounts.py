...
def get_default_stages_for_site(website_name: str) -> List[Dict]:
    ...
    common_stages = [
        {
            "type": StageType.EMAIL_VERIFICATION,
            "name": "Email Verification",
            "description": "Verify email address",
        },
        {
            "type": StageType.PROFILE_SETUP,
            "name": "Profile Setup",
            "description": "Complete profile information",
        },
        {
            "type": StageType.TERMS_ACCEPTANCE,
            "name": "Terms Acceptance",
            "description": "Accept terms and conditions",
        },
        {
            "type": StageType.ACCOUNT_ACTIVATION,
    ...
    site_specific = {
        "facebook": [
            {
                "type": StageType.PHONE_VERIFICATION,
                "name": "Phone Verification",
                "description": "Verify phone number",
            },
            {
                "type": StageType.HUMAN_VERIFICATION,
        ...
        "google": [
            ...
            {
                "type": StageType.TWO_FACTOR_AUTH,
                "name": "Two-Factor Auth",
                "description": "Set up 2FA",
            },
        ],
    }
